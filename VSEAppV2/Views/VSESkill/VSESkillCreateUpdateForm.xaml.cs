...
{
    public sealed partial class VSESkillCreateUpdateForm : UserControl
    {
        public VSESkillCreateUpdateForm()
        {
            this.InitializeComponent();
            this.DataContext = Ioc.Default.GetService<VSESkillCreateUpdateFormViewModel>();

            this.ViewModel.InitialFormSet += ViewModel_InitialFormSet;
        }
        public VSESkillCreateUpdateFormViewModel ViewModel => (VSESkillCreateUpdateFormViewModel)this.DataContext;
